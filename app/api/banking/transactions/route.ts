...
export async function GET(req: Request) {
  ...
  try {
    ...
    // Hardcoded start date of the year
    ...
    console.log('Extracted accountNum:', accountNum)
    ...
    const apiUrl = `https://bankaccountdata.gocardless.com/api/v2/accounts/${accountNum}/transactions/?date_from=${yearStart}&date_to=${dateTo}`
